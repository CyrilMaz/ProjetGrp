...
var ChapeauAventurier = Items{"Chapeau de l’aventurier", 1, "hat", 10, "all", "Equipment"}
var TuniqueAventurier = Items{"Tunique de l’aventurier", 1, "chest", 25, "all", "Equipment"}
var BottesAventurier = Items{"Bottes de l’aventurier", 1, "boots", 15, "all", "Equipment"}
